    ...
    <style>
        ...
        * {
        ...
        .inflection {
            ...
            overflow: hidden;
            background:
                url('https://www.mincultura.gov.co/despacho/congreso-artes-para-la-paz/PublishingImages/inflection-background.png') center center / cover no-repeat,
                #f8f2d8;
            color: var(--congreso-ink);
        }
        ...
        .mapping-hero {
            ...
            background:
                ...
                url('https://www.mincultura.gov.co/despacho/congreso-artes-para-la-paz/PublishingImages/mapping-hero-composite.png') left top / cover no-repeat,
                var(--congreso-violet);
        }
        ...
        .regional-cta {
            ...
            background:
                ...
                url('https://www.mincultura.gov.co/despacho/congreso-artes-para-la-paz/PublishingImages/regional-cta-background.png') center center / cover no-repeat;
            color: var(--congreso-ink);
        }
        ...
        @media (max-width: 767.98px) {
            ...
            .mapping-hero {
                ...
                background:
                    ...
                    url('https://www.mincultura.gov.co/despacho/congreso-artes-para-la-paz/PublishingImages/mapping-hero-composite.png') 23% top / auto 100% no-repeat,
                    var(--congreso-violet);
            }
            ...
            .regional-cta {
                ...
                background:
                    ...
                    url('https://www.mincultura.gov.co/despacho/congreso-artes-para-la-paz/PublishingImages/regional-cta-background.png') center center / auto 100% no-repeat;
            }
...
<body>
    ...
    <header class="site-nav" id="congreso-header">
        <nav class="container congreso-navbar" aria-label="Navegaci&#xF3;n principal">
            <a class="brand-mark" href="/">
                <img src="https://www.mincultura.gov.co/despacho/congreso-artes-para-la-paz/PublishingImages/header-logos.png" alt="Ministerio de las Culturas y OEI">
            </a>
    ...
    <main id="contenido">
        ...
        <section class="inflection" id="inscripcion">
            <img class="inflection-mask" src="https://www.mincultura.gov.co/despacho/congreso-artes-para-la-paz/PublishingImages/inflection-mask.png" alt=""
                aria-hidden="true">
            <img class="inflection-waves" src="https://www.mincultura.gov.co/despacho/congreso-artes-para-la-paz/PublishingImages/inflection-waves.png" alt=""
                aria-hidden="true">
        ...
        <section class="outcomes" id="lo-que-deja" aria-labelledby="outcomes-title">
            <img class="outcomes-mask" src="https://www.mincultura.gov.co/despacho/congreso-artes-para-la-paz/PublishingImages/outcomes-mask.png" alt=""
                aria-hidden="true">
            <img class="outcomes-character" src="https://www.mincultura.gov.co/despacho/congreso-artes-para-la-paz/PublishingImages/outcomes-character.png"
                alt="" aria-hidden="true">
        ...
        <section class="conversations" id="conversaciones" aria-labelledby="conversations-title">
            <img class="conversations-waves" src="https://www.mincultura.gov.co/despacho/congreso-artes-para-la-paz/PublishingImages/conversation-waves.png"
                alt="" aria-hidden="true">
                ...
                <div class="conversations-grid">
                    <article class="conversation-card">
                        <img class="conversation-icon"
                            src="https://www.mincultura.gov.co/despacho/congreso-artes-para-la-paz/PublishingImages/conversation-icon-policy.png" alt=""
                            aria-hidden="true">
                    ...
                    <article class="conversation-card">
                        <img class="conversation-icon"
                            src="https://www.mincultura.gov.co/despacho/congreso-artes-para-la-paz/PublishingImages/conversation-icon-model.png" alt=""
                            aria-hidden="true">
                    ...
                    <article class="conversation-card">
                        <img class="conversation-icon"
                            src="https://www.mincultura.gov.co/despacho/congreso-artes-para-la-paz/PublishingImages/conversation-icon-training.png" alt=""
                            aria-hidden="true">
                    ...
                    <article class="conversation-card">
                        <img class="conversation-icon"
                            src="https://www.mincultura.gov.co/despacho/congreso-artes-para-la-paz/PublishingImages/conversation-icon-knowledge.png" alt=""
                            aria-hidden="true">
        ...
        <section class="workflow" id="agenda" aria-labelledby="workflow-title">
            <img class="workflow-character" src="https://www.mincultura.gov.co/despacho/congreso-artes-para-la-paz/PublishingImages/workflow-character.png"
                alt="" aria-hidden="true">
            ...
            <div class="container workflow-inner">
                ...
                <div class="workflow-grid">
                    <article class="workflow-card">
                        <img class="workflow-icon" src="https://www.mincultura.gov.co/despacho/congreso-artes-para-la-paz/PublishingImages/workflow-icon-conferences.png"
                            alt="" aria-hidden="true">
                        <h3>Conferencias<br>magistrales</h3>
                    </article>

                    <article class="workflow-card">
                        <img class="workflow-icon" src="https://www.mincultura.gov.co/despacho/congreso-artes-para-la-paz/PublishingImages/workflow-icon-panels.png"
                            alt="" aria-hidden="true">
                        <h3>Paneles<br>comparados</h3>
                    </article>

                    <article class="workflow-card">
                        <img class="workflow-icon" src="https://www.mincultura.gov.co/despacho/congreso-artes-para-la-paz/PublishingImages/workflow-icon-tables.png"
                            alt="" aria-hidden="true">
                        <h3>Talleres</h3>
                    </article>
        ...
        <section class="policy" aria-labelledby="policy-title">
            <img class="policy-character" src="https://www.mincultura.gov.co/despacho/congreso-artes-para-la-paz/PublishingImages/policy-character.png" alt=""
                aria-hidden="true">
            ...
            <div class="container policy-inner">
                ...
                <div class="policy-layout">
                    <div class="policy-left">
                        ...
                        <img class="policy-map" src="https://www.mincultura.gov.co/despacho/congreso-artes-para-la-paz/PublishingImages/policy-map.png"
                    ...
                    <div class="policy-right">
                        ...
                        <div class="policy-photos" aria-label="Registro fotogr&#xE1;fico de Artes para la Paz">
                            <img src="https://www.mincultura.gov.co/despacho/congreso-artes-para-la-paz/PublishingImages/policy-photo-conductor.png" alt="">
                            <img src="https://www.mincultura.gov.co/despacho/congreso-artes-para-la-paz/PublishingImages/policy-photo-dancers.png" alt="">
                            <img src="https://www.mincultura.gov.co/despacho/congreso-artes-para-la-paz/PublishingImages/policy-photo-community.png" alt="">
                        </div>
                    </div>
                </div>
            </div>
        ...
        <section class="mapping" id="mapeo" aria-labelledby="mapping-title">
            <div class="mapping-hero">
                <img class="mapping-waves" src="https://www.mincultura.gov.co/despacho/congreso-artes-para-la-paz/PublishingImages/mapping-waves.png" alt=""
                    aria-hidden="true">
            ...
            <div class="mapping-logos" aria-label="Organizadores y aliados">
                <div class="container mapping-logos-inner">
                    <div class="mapping-logo-group">
                        ...
                        <img class="mapping-organizers" src="https://www.mincultura.gov.co/despacho/congreso-artes-para-la-paz/PublishingImages/mapping-organizers.png"
                            alt="Ministerio de las Culturas y OEI">
                    </div>

                    <div class="mapping-logo-group">
                        <p class="mapping-logo-label">Aliados</p>
                        <img class="mapping-allies" src="https://www.mincultura.gov.co/despacho/congreso-artes-para-la-paz/PublishingImages/mapping-allies.png"
        ...
        <section class="regional-cta" id="inscripcion" aria-labelledby="regional-cta-title">
            <img class="regional-cta-character" src="https://www.mincultura.gov.co/despacho/congreso-artes-para-la-paz/PublishingImages/regional-cta-character.png"
                alt="" aria-hidden="true">
    ...
    <footer class="site-footer">
        <div class="container site-footer-inner">
            ...
            <div class="footer-socials" aria-label="Redes sociales">
                <a class="footer-social-link" href="https://www.facebook.com/MinisterioCultura" target="_blank" rel="noopener noreferrer" aria-label="Facebook">
                    <img src="https://www.mincultura.gov.co/despacho/congreso-artes-para-la-paz/PublishingImages/footer-icon-facebook.png" alt="">
                </a>
                <a class="footer-social-link" href="https://x.com/mincultura" target="_blank" rel="noopener noreferrer" aria-label="X">
                    <img src="https://www.mincultura.gov.co/despacho/congreso-artes-para-la-paz/PublishingImages/footer-icon-x.png" alt="">
                </a>
                <a class="footer-social-link" href="https://www.instagram.com/mincultura/" target="_blank" rel="noopener noreferrer" aria-label="Instagram">
                    <img src="https://www.mincultura.gov.co/despacho/congreso-artes-para-la-paz/PublishingImages/footer-icon-instagram.png" alt="">
                </a>
                <a class="footer-social-link" href="https://www.youtube.com/@minculturascolombia" target="_blank" rel="noopener noreferrer" aria-label="YouTube">
                    <img src="https://www.mincultura.gov.co/despacho/congreso-artes-para-la-paz/PublishingImages/footer-icon-youtube.png" alt="">
                </a>
            </div>
        </div>
    </footer>
